...
public class ProlineFiles {
    ...
    public final static String PG_DATASTORE_RELATIVE_PATH = "data/databases/pg";
    ...
    public final static String H2_DATASTORE_RELATIVE_PATH = "data/databases/h2";
...
//        return getRessource("img/"+name);
    ...
    private static URL getRessource(String name) {
        ...
        if(url == null) logger.warn("Ressource '"+name+"' is not found");
        return url;
    }
